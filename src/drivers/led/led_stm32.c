...
#elif (CONFIG_OID_HWV2 == 1) || (CONFIG_YBS_MON == 1) || (CONFIG_IRT_MXC5324 == 1) || (CONFIG_IRT_UMX == 1) || (CONFIG_MISC_HUBCTRL == 1)  || (CONFIG_MISC_VWPLC == 1)
	/*PC0 RLED, PC1 GLED*/
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC, ENABLE);
...
#elif (CONFIG_MISC_COMPASS == 1) || (CONFIG_OID_HWV2 == 1) || (CONFIG_YBS_MON == 1) || (CONFIG_IRT_MXC5324 == 1)  || (CONFIG_IRT_UMX == 1) || (CONFIG_MISC_HUBCTRL == 1)  || (CONFIG_MISC_VWPLC == 1)
