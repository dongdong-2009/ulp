...
*/
#include "src\tasks\sss\drivers\sss_can.h"
#include "stdio.h"
#include <string.h>
#include "src\tasks\sss\sis_can.h"
#include "flash.h"
#include "time.h"
#include "src\tasks\sss\sis_decode.h"
#include "src\tasks\sss\sss_card.h"
#include "src\tasks\sss\drivers\sss_adc.h"
#include "nvm.h"
char sensor[7] = {
	1,//奇瑞EFS
	2,//奇瑞SIS
