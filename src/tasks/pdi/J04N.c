...
//pdi_jn can msg
static const can_msg_t jn_rst_msg =		{0x737, 8, {0x02, 0x11, 0x81, 0, 0, 0, 0, 0}, 0};
static const can_msg_t jn_clrdtc_msg =	{0x737, 8, {0x05, 0x31, 0x01, 0xf0, 0x05, 0, 0, 0}, 0};
static const can_msg_t jn_errcode_msg =	{0x737, 8, {0x03, 0x22, 0xfd, 0x39, 0, 0, 0, 0}, 0};
static const can_msg_t jn_getsn_msg =	{0x737, 8, {0x03, 0x22, 0xfd, 0x3f, 0, 0, 0, 0}, 0};
static const can_msg_t jn_reqseed_msg =	{0x737, 8, {0x02, 0x27, 0x61, 0, 0, 0, 0, 0}, 0};
static const can_msg_t jn_start_msg1 =	{0x737, 8, {0x02, 0x10, 0x03, 0, 0, 0, 0, 0}, 0};
static const can_msg_t jn_start_msg2 =	{0x737, 8, {0x02, 0x3E, 0x80, 0, 0, 0, 0, 0}, 0};
static const can_msg_t jn_start_msg3 =	{0x737, 8, {0x02, 0x3E, 0x00, 0, 0, 0, 0, 0}, 0};
...
static int jn_StartSession(void)
{
	...
	if (usdt_GetDiagFirstFrame(&jn_start_msg, 1, NULL, &msg, &msg_len))		//start session
		return 1;
#if PDI_DEBUG
	can_msg_print(&msg, "\n");
#endif
